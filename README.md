...
*This is the fork of [Yaoyao Liu&#39;s website](https://www.cs.jhu.edu/~yyliu/#about-me). Here is the source code of my homepage. I build this website based on [minimal](https://github.com/orderedlist/minimal).*
`<br>`
...
First, install [Ruby](https://www.ruby-lang.org/en/) and [Jekyll](https://jekyllrb.com/). The install instructions can be found here: [https://jekyllrb.com/docs/installation/#guides](https://jekyllrb.com/docs/installation/#guides)
...
[http://localhost:4000](http://localhost:4000). You can get the HTML files in `_site` folder.
